...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const coreRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${site.url}/about-hotel-excella`, lastModified: today, changeFrequency: "monthly", priority: 0.85 },
    { url: `${site.url}/why-book-direct`, lastModified: today, changeFrequency: "monthly", priority: 0.85 },
    { url: `${site.url}/guest-reviews`, lastModified: today, changeFrequency: "monthly", priority: 0.8 },
    { url: `${site.url}/restaurants-near-hotel-excella`, lastModified: today, changeFrequency: "monthly", priority: 0.8 },
    { url: `${site.url}/gallery`, lastModified: today, changeFrequency: "monthly", priority: 0.7 },
    { url: `${site.url}/amenities`, lastModified: today, changeFrequency: "monthly", priority: 0.7 },
  ...
  const landingRoutes = seoLandingPages.map((page) => ({
    ...
    priority: page.slug === "places-to-visit-near-hotel-excella" ? 0.9 : 0.8,
  }))
