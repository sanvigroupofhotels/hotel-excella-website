...
export const metadata: Metadata = pageMetadata({ title: "Hotel Excella FAQ", description: "Frequently asked questions about Hotel Excella near Beach Road, Rushikonda Beach, Kailasagiri, WiFi, breakfast options, guest services and family stays.", path: "/faq" })
