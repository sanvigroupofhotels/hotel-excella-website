...
export const attractions = [
  {
    ...
    description:
      "A landscaped coastal park known for open lawns, sea-breeze viewpoints and relaxed evening walks near Beach Road.",
  },
  {
    name: "Kailasagiri",
  ...
  },
  {
    ...
    description:
      "One of Vizag's most visited beaches, popular for long shoreline views, sunrise visits and coastal drives.",
  },
  {
